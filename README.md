...
- Each Voucher has id, title, description, published status.
- We can create, retrieve, update, delete Vouchers.
- There is a Search bar for finding Vouchers by title.

![vue-3-crud-example-axios-voucher](vue-3-crud-example-axios-voucher.png)
